...
/client/proc/play_web_sound()
	...
	if(istext(web_sound_input))
		...
		if(length(web_sound_input))
			...
			// var/list/output = world.shelleo("[ytdl] --format \"bestaudio\[ext=mp3]/best\[ext=mp4]\[height<=360]/bestaudio\[ext=m4a]/bestaudio\[ext=aac]\" --dump-single-json --no-playlist -- \"[shell_scrubbed_input]\"") //LUMOS EDIT
			var/list/output = world.shelleo("[ytdl] --format 'bestaudio\[ext=mp3]/best\[ext=mp4]\[height<=360]/bestaudio\[ext=m4a]/bestaudio\[ext=aac]' --dump-single-json --no-playlist -- \"[shell_scrubbed_input]\"") //LUMOS EDIT - LINUX FRIENDLY
