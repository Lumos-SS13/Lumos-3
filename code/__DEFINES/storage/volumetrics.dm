...
#define MAX_WEIGHT_CLASS_DUFFLEBAG_OF_HOLDING		WEIGHT_CLASS_HUGE // Lumos change
...
#define STORAGE_VOLUME_DUFFLEBAG_OF_HOLDING			(DEFAULT_VOLUME_NORMAL * 30) // Lumos change
