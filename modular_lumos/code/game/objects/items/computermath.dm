...
/obj/item/computermath
	icon = 'modular_lumos/icons/obj/computermath.dmi'
	verb_say = "beeps"
	var/charge_count
...
/obj/item/computermath/default
	...
	var/static/radial_cargo = image(icon = 'modular_lumos/icons/obj/computermath.dmi', icon_state = "cargotab")
	var/static/radial_science = image(icon = 'modular_lumos/icons/obj/computermath.dmi', icon_state = "sciencetab")
